            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <div class="user-profile">
                    <div class="dropdown user-pro-body">
                        ...
                        <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Nahda Fauziyah <span class="caret"></span></a>
                ...
                <ul class="nav" id="side-menu">
                    <li> <a href="index.html" class="waves-effect"><i class="mdi mdi-av-timer fa-fw" data-icon="v"></i> <span class="hide-menu"> My Account <span class="fa arrow"></span> </span></a>
                        <ul class="nav nav-second-level">
                            <li> <a href="index.html"><i class=" fa-fw">1</i><span class="hide-menu">My Account</span></a> </li>
                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="../plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h5 class="text-white">nahdafauziyah@gmail</h5> </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <ul class="nav nav-tabs tabs customtab">
                                ...
                                <li class="tab">
                                    <a href="#messages" data-toggle="tab" aria-expanded="true"> <span class="visible-xs"><i class="fa fa-envelope-o"></i></span> <span class="hidden-xs">Product</span> </a>
                                </li>
                                <li class="tab">
                               ...
                               <div class="tab-pane" id="profile">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Username</strong>
                                            <br>
                                            <p class="text-muted">NahdaFA</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Nama</strong>
                                            <br>
                                            <p class="text-muted">Nahda Fauziyah A</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>Alamat</strong>
                                            <br>
                                            <p class="text-muted">Jalan Mulyosari satu no.5, Mulyorejo, Surabaya,Jawa Timur</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6 b-r"> <strong>No Hp</strong>
                                            <br>
                                            <p class="text-muted">081211540871</p>
                                        </div>
                                        <div class="col-md-3 col-xs-6"> <strong>Email</strong>
                                            <br>
                                            <p class="text-muted">nahdafa@gmail.com</p>
                                        </div>
                                    </div>
                                    <!-- <hr>
